...
Incluye paquetes como:
  ...
  <p float="left">
    <img src="imagenes/logo_dplyr.png" style="width:15%; margin-right:20px;"  />
  <img src="imagenes/logo_tidyr.png"style="width:15%; margin-right:20px;" /> 
  <img src="imagenes/logo_purrr.png"style="width:15%; margin-right:20px;" /> 
  ...
  <p float="left">
  <img src="imagenes/logo_readxl.png" style="width:15%; margin-right:20px;"  />
  <img src="imagenes/logo_readr.png"style="width:15%; margin-right:20px;" /> 
  <img src="imagenes/logo_haven.png"style="width:15%; margin-right:20px;" /> 
  
  
   Listado completo de paquetes <a href="https://tidyverse.tidyverse.org/">aquí</a>
